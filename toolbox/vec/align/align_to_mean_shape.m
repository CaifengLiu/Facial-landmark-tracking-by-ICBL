function [Sxy, cropIm] = align_to_mean_shape(MeanShape, img , xy , options)
...
NumPts = options.num_pts;

MeanX = MeanShape(1:2:end);
MeanY = MeanShape(2:2:end);

[d AlignXY tform] = procrustes([MeanX MeanY], xy, 'Reflection',false);%求得xy到MeanXY的变换
